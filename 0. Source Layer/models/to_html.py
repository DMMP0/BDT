...
class HTML:
	...
	def bank_html(self):
			...
			for index,item in bank_data.iterrows():
				...
				bank_data.loc[index,'house_mortage'] = random.randint(0,10)
				bank_data.loc[index,'amount_of_house_mortage'] = "${:,.2f}".format(val + random.randint(5000,100000000000))
				bank_data.loc[index,'amount_duee_mortage'] ="${:,.2f}".format(val + random.randint(5000,100000000000))
				...
				bank_data.loc[index,'credit_card_number'] = ccard.visa()
				bank_data.loc[index,'actual_debit_credit_cards'] ="${:,.2f}".format(val + random.randint(5000,100000000000))
